-- ==========================================
-- CSE340 - Assignment 2 (Task Two Rebuild)
-- File: database/rebuild.sql
-- Creates schema, seeds data, then applies:
--   - Task 1 #4 (description update)
--   - Task 1 #6 (image path update)
-- ==========================================

BEGIN;

-- Clean reset (safe for rebuild)
...
-- helpful index
CREATE INDEX IF NOT EXISTS idx_inventory_classification_id
...
-- 4) account (varchar default 'Client')
...
('SUV'), ('Sedan'), ('Truck'), ('Sports'), ('Compact');

-- inventory (15) — same set you’ve been using
...
-- ===== Append Task 1 #4 and #6 (must be last) =====

-- (Task 1 #4) GM Hummer description phrase update
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- (Task 1 #6) Add '/vehicles' to image paths
UPDATE public.inventory
SET
